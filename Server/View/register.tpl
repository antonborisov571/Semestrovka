                                    ...
                                    <form class="mx-1 mx-md-4" action="/register" method="post">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <span id="labelEmail" style="color:red"></span>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input id="tractorName" name="tractorName" class="form-control" />
                                                <label class="form-label" for="tractorName">Модель трактора
                                                    (Необязательно)</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center mb-5 not-active">
